...
import time
#mysql connector로 파이썬을 이용해 DB입력을 쉽게 해주는 코드입니다.
#날림으로 만들어서 좀 부족한 부분이 있으니 참고해주세용.
#MySQL 생성시 입력하신 유저 ID와 비밀번호를 입력해주세요.
...
#MySQL에 연결해주는 코드입니다. DB명은 DBTeamProject가 디폴트입니다.
#혹시 기존에 이미 같은 이름의 DB가 만들어져있으면 드랍해버리고 새로 만들어줍니다.
...
#랜덤 숫자를 생성해주는 코드. 동/호수를 랜덤으로 만들어줍니다.
